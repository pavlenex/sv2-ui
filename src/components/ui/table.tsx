...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-border/70 bg-muted/35 font-medium [&>tr]:last:border-b-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border/65 transition-colors hover:bg-primary/5 data-[state=selected]:bg-primary/10',
      className
    )}
    {...props}
  />
